...
const Register = ({setRegisterOver}) => {
  ...
  return (
    <div className={isHiden ? "register hideRegister" : "register showRegister"} >
      <div className='arrow_close' onClick={() => hiDeOverlay(navigateToMain)}><img src="../../public/img/other/arrow_register.svg" alt="" /></div>
      ...
      <div className='auth_container Container_email'>
        ...
        <div className='auth_submit btn' onClick={() => handleSubmit()}><p>Register</p></div>
      </form>
