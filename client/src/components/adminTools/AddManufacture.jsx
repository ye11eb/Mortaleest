                            ...
                            <div className="inputContainer options_input_box">
                                <div className="field">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setOptionQuantity(e.target.value)
                                        }
                                    />
                                    <span className="field__label-wrap">
                                        <span className="field__label">
                        ...
                        <div className="inputContainer">
                            <div className="field">
                                ...
                                <input
                                    ...
                                    value={priceValueEng}
                                    onChange={(e) =>
                                        setPriceValueEng(e.target.value)
                                    }
                                />
                                <span
                                    className="field__label-wrap"
                        ...
                        <div className="inputContainer">
                            <div className="field">
                                ...
                                <input
                                    ...
                                    value={colectionsEng}
                                    onChange={(e) =>
                                        setColectionsEng(e.target.value)
                                    }
                                />
                                <span
                                    className="field__label-wrap"
                        ...
                        <div className="inputContainer">
                            <div className="field">
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setClothesTypeEng(e.target.value)
                                    }
                                />
                                <span
                                    className="field__label-wrap"
                            ...
                            <div className="inputContainer options_input_box">
                                <div className="field">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setOptionColorEng(e.target.value)
                                        }
                                    />
                                    <span className="field__label-wrap">
                                        <span className="field__label">
                            ...
                            <div className="inputContainer options_input_box">
                                <div className="field">
                                    ...
                                    <input
                                        ...
                                        value={optionSizeEng}
                                        onChange={(e) =>
                                            setOptionSizeEng(e.target.value)
                                        }
                                    />
                                    <span className="field__label-wrap">
                                        <span className="field__label">
                            ...
                            <div className="inputContainer options_input_box">
                                <div className="field">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setOptionQuantityEng(e.target.value)
                                        }
                                    />
                                    <span className="field__label-wrap">
                                        <span className="field__label">
                ...
                <div className="branch scroll">
                    ...
                    {images.map((img) => (
                        <div
                            ...
                            key={img}
                            onClick={() =>
                                deleteAdedItem(img, images, setImages)
                            }
                        >
                            <img src={img} alt="" />
                            <div>DELETE</div>
