...
export const Main = ({
    ...
    const [visibleManufactures, setVisibleManufactures] =
            ...
            <div className="main_container">
                <div className="faqs container">
                    ...
                    <div className="faqs_links">
                        <div>
                            <p>
                                <span> Mail:</span> <a>mortaleest@gmail.com</a>
                                <div className="mail"></div>
                            </p>
                        </div>
                        <div>
                            <p>
                                <span>Location:</span> <a>Ternopil, Ukraine</a>
                                <div className="mail"></div>
                            </p>
                        </div>
                        <div>
                            <p>
                                <span>Follow us:</span> <a>@mortaleest</a>
                                <div className="mail"></div>
                            </p>
                        </div>
                    </div>
