...
const EditEmailPass = ({userInfo, setNewEmail, fetchUserInfo}) => {
  ...
  return (
    <div className={isHidenPass ? "register hideRegister" : "register showRegister"} >
      ...
      {enterEmail && <EditEmail password={password} fetchUserInfo={fetchUserInfo} setEnterEmail={setEnterEmail} setIsHidenPass={setIsHidenPass} userInfo={userInfo} setNewEmail={setNewEmail}/>}
    </div>
  );
}
