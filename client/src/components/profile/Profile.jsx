...
const Profile = ({isStaff, itemForEdit}) => {
  ...
  return (
    <>
    {isStaff ? 
    <AddManufacture isHiden={isHiden} hiDeOverlay={hiDeOverlay} navigateToMain={navigateToMain} itemForEdit={itemForEdit}/>
       :
      ( 
          ...
          <div className='account_main'>
            ...
            <div className='account_split'>
              <div className='account_container'>
                {userInfo && <div className="accName">
                ...
                <div className='email_container'>
                  ...
                  <div onClick={() => setNewEmail(true)}>EDIT EMAIL <span></span></div>
                </div>
                ...
                <div className='history'>
                  ...
                  {ordersIDs && ordersIDs.map((item) => {
                    <div className='history_order' key={item._ID}>
                      {/* <img src="" alt="" /> */}
              ...
              <div className='account_container_v2'>
                ...
                <div className="Personal_info_container">
                  ...
                  {userInfo && <div className='Personal_info'>
                    ...
                    <div className='Personal_info_info'>
                      <p>{userInfo.firstName}</p>
                      <p>{userInfo.secondName}</p>
                      <p>{userInfo.number ? userInfo.number : 'No info'}</p>
                    </div>
                ...
                <div className="Address_info_container">
                  ...
                  <div className="Account_address">
                    ...
                    {userInfo && <div className='Personal_info_info'>
                  ...
                  <div className='Edit_shipping_adress' onClick={() => openOverlay(navigateToEditAddres())}>EDIT SHIPPING ADRESS <span></span></div>
                </div>
              </div>
              
  
            </div>
            {addShippingAddress && <EditFirstInfo fetchUserInfo={fetchUserInfo} userInfo={userInfo} SetAddShippingAddress={SetAddShippingAddress}/>}
            {newEmail && <EditEmailPass fetchUserInfo={fetchUserInfo} userInfo={userInfo}  setNewEmail={setNewEmail}/>}
          </div>
        </div>
        )}
    </>
