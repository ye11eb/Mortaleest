...
const EditSecondInfo = ({setIsHidenFirst, userInfo, SetAddShippingAddress, fetchUserInfo, setSecondInfo, firstName, secondName ,number, setFirstName, setSecondName, setNumber}) => {
  ...
  const handleSubmit = () => {
    try{
      dispatch(deliveryInfo({firstName, secondName, number, adress1, adress2, country, city, state, zipcode }))
      setFirstName('')
      setSecondName('')
      setNumber('')
      setAdress1('')
  ...
  return (
    <div className={isHidenSecond ? "register hideRegister" : "register showRegister"} >
      <span className='arrow_auth' onClick={() => hiDeOverlay(navigateToFirst)}><img src="../../public/img/other/arrow_register.svg" alt="" /></span>
