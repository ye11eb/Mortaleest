...
export const Login = () => {
  ...
  return (
    <>
    <div className={isHiden ? "login hideOverlay" : "login showOverlay"} >
      ...
      <h1 className='headerOverlay'>Login</h1>
        ...
        <div className='inputContainer'>
          <div className="field">
              <label for="first-name" className="ha-screen-reader">Email</label>
        ...
        <div className='auth_container Container_password'>
          ...
          <div className='inputContainer'>
              <div className="field">
                <label for="first-name" className="ha-screen-reader">Password</label>
                <input id="first-name" className="field__input" 
        ...
        <div className='auth_submit btn' onClick={() => handleSubmit()}><p>SIGN IN</p><span></span></div>
        <p className='switchAuth' onClick={() => navigateToRegister()}>Create account</p>
      </form>
