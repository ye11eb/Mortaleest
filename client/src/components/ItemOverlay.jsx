...
export const ItemOverlay = ({
    ...
    const [title, setTitle] = useState(
        ukrLoc ? openedItem.title : openedItem.titleEng
    );
    const [name, setName] = useState(
        ukrLoc ? openedItem.name : openedItem.nameEng
    );
    const [price, setPrice] = useState(
        ukrLoc ? openedItem.price : openedItem.priceEng
    );
    const [description, setDescription] = useState(
        ukrLoc ? openedItem.description : openedItem.descriptionEng
    );
    const [priceValue, setPriceValue] = useState(
        ukrLoc ? openedItem.priceValue : openedItem.priceValueEng
    );
    ...
    return (
        <div
            className={
                isHiden ? 'itemOverlay hideOverlay' : 'itemOverlay showOverlay'
            }
        >
            <div className="item_overlay_main">
                    ...
                    <div className="ItemSellect size">
                        ...
                        <ul className="dropDownList_Item">
                            <li
                                ...
                                className={
                                    descriptionOpened && 'OpenedDropDownList'
                                }
                            >
                            ...
                            <li
                                onClick={() => setSizingOpened(!sizingOpened)}
                                className={
                                    sizingOpened && 'OpenedDropDownListPhoto'
                                }
                            >
                                <div className="dropDownList_Item_fstLine">
                                    {ukrLoc ? (
                ...
                data:image/jpeg;base64,"
                            ...
                            <li
                                onClick={() =>
                                    setMaterialsOpened(!materialsOpened)
                                }
                                className={
                                    materialsOpened && 'OpenedDropDownList'
                                }
                            >
                                <div className="dropDownList_Item_fstLine">
                                    {ukrLoc ? (
