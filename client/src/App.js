...
function App() {
  ...
  const [pickedSortOption, setPickedSortOption] = useState({'eng' : 'all manufactures', 'ukr' : 'всі вироби'})
  ...
  return (
    ...
    <Main 
      ...
      pickedSortOption = {pickedSortOption} 
      setPickedSortOption = {setPickedSortOption}
      openedItem = {openedItem} ukrLoc={ukrLoc} 
      sortedCollections = {sortedCollections}
      sortedClothes = {sortedClothes}
      mainTitle = {mainTitle}
    />	
    ...
    <Routes>
      ...
      <Route path='profile' element = {<Profile isStaff={isStaff} itemForEdit={itemForEdit}/>} />
